...
# Benutzer nach Kommentar fragen
kommentar = input("Gib einen Kommentar ein (und drücke die ENTER Taste) >>>")
# wurde wirklich etwas eingegeben ?
if len(kommentar) == 0:                     # es wurde nur auf die Enter Taste gedrückt
    ziel = ziel_ordner + os.sep + heute + os.sep + jetzt + ".zip"
else:                                       # es wurde ein Kommentar eingegeben
    kommentar = kommentar.replace(" ", "_") # Leerzeichen durch Unterstriche ersetzten
